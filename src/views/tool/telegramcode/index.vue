...
<!--      </el-form-item>-->
    ...
    <div class="code-input-container">
      <el-form-item prop="inputCode">
        <el-input
            ...
            type="textarea"
            :rows="6"
            placeholder="输入文本" style="width: 100%; font-size: 18px;"
        />
      </el-form-item>
    </div>
    ...
    <div class="button-container">
      <el-button type="primary" icon="Key" @click="executeDecode">解码</el-button>
      <el-button type="primary" icon="Unlock" @click="executeEncode">编码</el-button>
      <el-button icon="Refresh" @click="resetQuery">重置</el-button>
    </div>
...
function executeEncode() {
  ...
  proxy.$refs.queryRef.validate((valid) => {
    if (valid) {
      encodeExecute(
          queryParams.value.equipmentType,
          queryParams.value.inputCode
      ).then(response => {
